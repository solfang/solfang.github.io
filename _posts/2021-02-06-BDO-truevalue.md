...
Knowing the true value of rare materials becomes important once you're comparing different recipes. Theer are two scenarios where calculating the true value can prove useful:
...
It may sound a little complicated now but it's pretty easy once you got the hang of it: Calculate the true value of a rare material, then plug it into a gathering calculator and note down the profit/h. Doe the same a different rare material and compare the profit/h to that of the first material. Takes like 2 minutes with a cooking and a gathering spreadsheet.
