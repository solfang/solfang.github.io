...
## Scenario 1: Coconuts
We have collected a large stockpile of coconut from our Arehaza storage and want to know the most profitable way to liquidate the coconuts. Potential recipes are: coconut cocktails, coconut dried fish and coconut pasta. After calculating the profit, coconut dried fish turns the most profit per hour. But it also takes three coconuts per craft while the other two recipes take two. So with coconut fried fish we'd be making more silver per hour but couldn't cook for as long. So now it would be interesting to know which recipes creates the most profit **per coconut** to get a measure that doesn't depend on the time it takes to cook the coconut. 

By calculating the true value per coconut across the three recipes we then can decide which recipe is the most worthwhile. Of course, completely ignoring the time it takes to cook the coconuts would be disingenious. But if we calculate the true profit using the method outlined in See [Section 3](#how-to-calculate-the-true-value-of-a-rare-mat-in-a-recipe), the time spent cooking will also be factored in. The cool thing is that if we also wanted to consider other recipes that use coconuts, like pine coated plywood, it wouldn't be hard to calculate the true value for those either.

## Scenario 2: Rough stone vs. lion meat gathering

We have acquired two shiny new manos tools: a Tet pickaxe and a Tet butchering knive. Now we want to know: what is more profitable - gathering rough stone, turning them into advanced cooking utensils and selling the utensils *or* gathering lion mean, cooking cooking it into hamburgs and selling them to the market. 

A possible way to compare both options would be to gather an hour of rough stone and then count the time it takes to turn it into utensils. Example: 1 hour of gathering rough stone, 5 hours of workshop crafting, total: 6 hours. Afterwards, we'd gather lions for an hour and count the time it takes to cook the meat into hamburgs. Example: 1 hour of gathering and 1 hour of cooking, total: 2 hour. We could now divide the total silver made from the utensil sales by the invested time (6 hours) and the profit from the hamburg crafts by the invested time (2 hours) to calculate the average profit per hour on the two activities. The activity with the higher profit per hour would be more worthwile then, right?. A huge flaw with this approach is that it values the gathering time the same as workshop and also the cooking time. Gathering is fully active while cooking is semi-afk and workshops are very low effort, basically passive. So in reality, the 6 hours running the utensil workshop should not weight as much as the 1 hour cooking. The gathering time is 1 hour in both cases so that one's a fair comparison.

One solution would be to factor out the time spent cooking and the workshop time by assigning a static cost to them. Say you'd expect to make 10 mil/h from cooking and 1 mil/h from workshops. We could now subtract the cost of cooking for 1 hour (10 mil) and the cost of running the utensil workshop for 6 hours (6 mil) from the hamburg and utensil profit respectively. By asigning those costs to the cooking/workshop time we're basically paying an NPC to process the materials for us. So after paying the NPC we have a bunch of silver left (created by the cooking and workshop) that we would like to feed back into the gathering calculation. Assume that the gathering spreadsheet we use asks for a price on each material. So, which value do we input for the lion meat and rough stone? We take the profit generated by cooking / the utensil workshop that's left after (figuratively) paying the NPC to process the materials for us and divide it evenly among the lion meat / rough stone. For the lion meat that would be: (silver from cooking) / (number of lion meat used) = value of one lion meat. Similar for the rough stone. We can take this value and plug it back into the gathering profit calculation. Now we can cleanly compare the profit of one hour gathering lion meat to one hour gathering rough stone.
